...
set message fg="$onedark_white",bg="$onedark_black"

set message-command fg="$onedark_white",bg="$onedark_black"

set "status-attr" "none"
set "status-left-attr" "none"

setw window-status fg="$onedark_black",bg="$onedark_black",attr="none"

setw window-status-activity bg="$onedark_black",fg="$onedark_black",attr="none"
...
set status bg="$onedark_black",fg="$onedark_white"
...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_white,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_white,bold] #h #[fg=$onedark_yellow, bg=$onedark_white]#[fg=$onedark_red,bg=$onedark_yellow]"
set "status-left" "#[fg=$onedark_black,bg=$onedark_white,bold] #S #{prefix_highlight}#[fg=$onedark_white,bg=$onedark_black,nobold,nounderscore,noitalics]"
